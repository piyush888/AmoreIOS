...
//    static var requestInProcessing: Bool = false
//    // time out after continious error from backend
//    var timeOutRetriesCount: Int = 0
//    var adminAuthModel = AdminAuthenticationViewModel()
//    static var apiURL = "http://127.0.0.1:5000"
//    
