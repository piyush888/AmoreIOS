...
struct customNavBar_Previews: PreviewProvider {
    static var previews: some View {
        customNavBar(toUser: ChatUser(id: "QvV4OoZmZ3QWHhMNaZrr7lkqmLF3", firstName: "Jason", lastName: "Kalkanus", image1: ProfileImage(imageURL: URL(string: "https://firebasestorage.googleapis.com/v0/b/amore-f8cd6.appspot.com/o/images%2FQvV4OoZmZ3QWHhMNaZrr7lkqmLF3%2Fimage1640439314.5542731.heic?alt=media&token=cb324857-1cf9-4ee1-b208-ddba11751275") , firebaseImagePath: "images/QvV4OoZmZ3QWHhMNaZrr7lkqmLF3/image1640439314.5542731.heic")), presentProfileCard: Binding.constant(false))
